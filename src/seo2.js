...
const bannersData = [
    {
        ...
        secondaryHeading: "Our expert SEO strategies at V-Soft Solutions are designed to enhance your website’s visibility on search engines, attract organic traffic, and improve your overall search engine rankings.",
        buttonText: "EXPLORE",
        image: image,  
      },
...
<li ref={(el) => (listRefs.current[0] = el)}>
  ...
  <div class="row d-flex justify-content-center text-center">
    <div class="col-lg-8">
      <h2 class="service-page-heading">Search Engine Optimatization Services</h2>
      <p class="mb-0"   style={{ 
            marginTop:'2rem'
          }}>Since 2024, our Tirunelveli-based company has been enhancing website visibility with expert SEO strategies. We specialize in improving search engine rankings, driving organic traffic, and delivering measurable results.</p>
    </div>
  </div>
</div>
  ...
  <div class="container-fluid service-page-detail-con">
    <div class="service-page-detail-sub2">
      ...
      <div class="service-page-detail-item-bl" data-aos="fade-up" data-aos-delay="100">
        <h3>On-Page SEO</h3>
        <p>Optimize your website's content and structure to improve its visibility on search engines and ensure it meets the latest SEO standards.</p>
      </div>
      <div class="service-page-detail-item-wh" data-aos="fade-up" data-aos-delay="200">
        <h3>Off-Page SEO</h3>
        <p>Enhance your website's authority through strategic backlink building, social signals, and brand mentions across the web.</p>
      </div>
      <div class="service-page-detail-item-wh" data-aos="fade-up" data-aos-delay="300">
        <h3>Technical SEO</h3>
        <p>Ensure your website is crawlable, indexable, and fast-loading with our comprehensive technical SEO services.</p>
      </div>
      <div class="service-page-detail-item-bu" data-aos="fade-up" data-aos-delay="400">
        <h3>Keyword Research</h3>
        <p>Identify the most valuable keywords for your business and target them effectively to drive high-quality traffic to your website.</p>
      </div>
    </div>
    <div class="service-page-detail-sub3">
      <div class="service-page-detail-item-bu" data-aos="fade-up" data-aos-delay="100">
        <h3>Local SEO</h3>
        <p>Boost your presence in local search results and attract nearby customers with our focused local SEO strategies.</p>
      </div>
      <div class="service-page-detail-item-wh" data-aos="fade-up" data-aos-delay="200">
        <h3>Mobile SEO</h3>
        <p>Optimize your website for mobile devices to ensure a seamless experience and improved search rankings on mobile searches.</p>
      </div>
      <div class="service-page-detail-item-wh" data-aos="fade-up" data-aos-delay="300">
        <h3>E-commerce SEO</h3>
        <p>Enhance the visibility of your online store, driving more traffic and sales through targeted e-commerce SEO strategies.</p>
      </div>
      <div class="service-page-detail-item-bl" data-aos="fade-up" data-aos-delay="400">
        <h3>SEO Audits</h3>
        <p>Get a comprehensive analysis of your website's SEO performance with our detailed SEO audits, identifying areas for improvement.</p>
      </div>
      <div class="service-page-detail-item1" data-aos="fade-up" data-aos-delay="500">
  ...
  <div class="container-fluid service-page-detail-con-mobile">
    <div class="service-page-detail-sub1-item-wh" data-aos="fade-up" data-aos-delay="100">
      ...
      <p>Enhance your content with targeted keywords, meta descriptions, and proper formatting to improve its search visibility.</p>
    </div>
    <div class="service-page-detail-sub1-item-bu" data-aos="fade-up" data-aos-delay="200">
      <h3>Link Building</h3>
      <p>Build high-quality backlinks that drive traffic and improve your website's domain authority.</p>
    </div>
    <div class="service-page-detail-sub1-item-wh" data-aos="fade-up" data-aos-delay="300">
      <h3>SEO Reporting</h3>
      <p>Track your SEO performance with detailed reports that highlight progress, insights, and areas for further improvement.</p>
    </div>
    <div class="service-page-detail-sub1-item-bl" data-aos="fade-up" data-aos-delay="400">
      <h3>Competitor Analysis</h3>
      <p>Gain insights into your competitors' SEO strategies and discover opportunities to outperform them in search rankings.</p>
    </div>
    <div class="service-page-detail-item-wh" data-aos="fade-up" data-aos-delay="100">
      <h3>Image SEO</h3>
      <p>Optimize images on your website to improve loading times, user experience, and search engine rankings.</p>
    </div>
    <div class="service-page-detail-item-bu" data-aos="fade-up" data-aos-delay="200">
      <h3>Voice Search Optimization</h3>
      <p>Prepare your website for the future by optimizing it for voice search, capturing a growing segment of search traffic.</p>
    </div>
    <div class="service-page-detail-item-wh" data-aos="fade-up" data-aos-delay="300">
      <h3>Schema Markup</h3>
      <p>Implement structured data on your website to help search engines understand your content and improve how it's displayed in search results.</p>
    </div>
    <div class="service-page-detail-item-bl" data-aos="fade-up" data-aos-delay="400">
      <h3>Website Speed Optimization</h3>
      <p>Improve your website's loading speed, enhancing user experience and boosting search engine rankings.</p>
    </div>
    <div class="service-page-detail-item-wh" data-aos="fade-up" data-aos-delay="100">
      <h3>International SEO</h3>
      <p>Expand your reach across global markets with tailored SEO strategies that target international audiences.</p>
    </div>
    <div class="service-page-detail-item-bu" data-aos="fade-up" data-aos-delay="200">
      <h3>SEO for Startups</h3>
      <p>Get your startup noticed with SEO strategies that are tailored to your business needs and growth goals.</p>
    </div>
    <div class="service-page-detail-item-wh" data-aos="fade-up" data-aos-delay="300">
      <h3>Analytics and Reporting</h3>
      <p>Monitor and measure the success of your SEO efforts with our comprehensive analytics and reporting services.</p>
    </div>
    <div class="service-page-detail-item-bl" data-aos="fade-up" data-aos-delay="400">
      <h3>SEO Consultation</h3>
      <p>Get expert advice and guidance on how to improve your website's SEO performance and achieve your online goals.</p>
    </div>
  </div>
</div>
