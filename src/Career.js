...
const bannersData = [
  {
    headings: "Welcome",
    secondaryHeading:
      "At VSoft Solutions, we believe in the power of innovation and creativity.",
    buttonText: "EXPLORE",
    image: image,
  },
];
  ...
  return (
    <div className="form-popup">
      ...
      <div className="form-content">
        ...
        >
          Course Training and Internship Form
        </h2>
    ...
    <div className="form-container">
      ...
      >
        <div className="cards">
          ...
          <ul>
            <li>
              <i className="fas fa-check red-tick"></i> Gain valuable
              technologies Training
            </li>
            <li>
              <i className="fas fa-check red-tick"></i> Mentorship from
              experienced professionals
            </li>
            <li>
              <i className="fas fa-check red-tick"></i> Opportunity to work on
              real-world projects
            </li>
            <li>
              <i className="fas fa-check red-tick"></i> Flexible Training hours
            </li>
          </ul>
          <button
            onClick={handleMenuToggls}
            style={{
              backgroundColor: isHovered
                ? " rgba(10, 60, 100, 0.979)"
                : "white",
        ...
        <div className="cards">
          ...
          <ul>
            <li>
              <i className="fas fa-check red-tick"></i> Competitive stipend
            </li>
            <li>
              <i className="fas fa-check red-tick"></i> Access to advanced tools
              and technologies
            </li>
            <li>
              <i className="fas fa-check red-tick"></i> Networking opportunities
              with industry leaders and Practical Tasks
            </li>
            <li>
              <i className="fas fa-check red-tick"></i> Potential for full-time
              employment
            </li>
          </ul>
          <button
            onClick={handleMenuTogglss}
            style={{
              backgroundColor: isHovered
                ? " rgba(10, 60, 100, 0.979)"
                : "white",
        ...
        <div className="cards">
          ...
          <ul>
            <li>
              <i className="fas fa-check red-tick"></i> Competitive salary and
              benefits
            </li>
            <li>
              <i className="fas fa-check red-tick"></i> Career development and
              training programs
            </li>
            <li>
              <i className="fas fa-check red-tick"></i> Positive and inclusive
              work environment
            </li>
            <li>
              <i className="fas fa-check red-tick"></i> Opportunities for
